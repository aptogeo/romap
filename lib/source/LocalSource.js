...
var LocalSource = /** @class */ (function (_super) {
    __extends(LocalSource, _super);
    ...
    LocalSource.prototype.clearForReload = function () {
        _super.prototype.clear.call(this, true);
    };
    LocalSource.prototype.clear = function (fast) {
        this.savedFeatures = null;
        _super.prototype.clear.call(this, fast);
    };
    LocalSource.prototype.projectAll = function () {
    ...
    LocalSource.prototype.reportAll = function () {
        if (this.savedFeatures) {
    ...
    LocalSource.prototype.setOriginal = function (feature) {
    ...
    LocalSource.prototype.handleAddFeature = function (event) {
        this.setOriginal(event.feature);
    };
    LocalSource.prototype.handleChangeFeatureGeometry = function (event) {
        this.setOriginal(event.feature);
    };
    LocalSource.prototype.handleChangeGeometry = function (event) {
