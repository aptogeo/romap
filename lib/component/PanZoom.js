...
var PanZoom = /** @class */ (function (_super) {
    ...
    PanZoom.prototype.renderPan = function () {
        ...
        if (this.props.showOrigin) {
            origin = (React.createElement("button", { className: this.props.className + "-origin", onClick: this.handleOrigin.bind(this), title: originTitle }));
        }
        else {
    ...
    PanZoom.prototype.renderZoom = function () {
        ...
        if (this.props.showZoomSlider) {
            slider = (React.createElement("div", { className: this.props.className + "-zoom-slider" },
                React.createElement("button", { className: this.props.className + "-zoom-slider-thumb" })));
        }
        return (React.createElement("div", null,
